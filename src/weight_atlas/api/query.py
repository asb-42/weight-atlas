...
def discovery_body() -> dict[str, Any]:
    ...
    endpoints = [
        ...
        {"method": "GET", "path": "/models", "purpose": "list all scans", "params": []},
        {"method": "GET", "path": "/model/{model_id}", "purpose": "scan metadata + baseline", "params": []},
        {"method": "GET", "path": "/model/{model_id}/summary", "purpose": "model-wide aggregates", "params": ["group_by", "metrics"]},
        {"method": "GET", "path": "/model/{model_id}/layer/{n}", "purpose": "all tensors in one layer, intra-layer comparison", "params": []},
        {"method": "GET", "path": "/model/{model_id}/anomalies", "purpose": "statistically unusual tensors", "params": ["metric", "threshold", "method", "n", "direction", "type", "layer_range", "fields"]},
        {"method": "GET", "path": "/model/{model_id}/query", "purpose": "filtered, sorted, paginated tensor list", "params": ["layer", "type", "metric", "order", "fields", "limit", "offset", "min", "max"]},
        {"method": "GET", "path": "/model/{model_id}/compare", "purpose": "two slices within one model", "params": ["a", "b", "metrics", "fields"]},
        {"method": "GET", "path": "/model/{model_id}/histogram", "purpose": "distribution of a metric", "params": ["metric", "bins", "log", "type", "layer_range", "density"]},
        {"method": "GET", "path": "/model/{model_id}/tensor/{name}", "purpose": "full detail for one tensor", "params": []},
        {"method": "GET", "path": "/model/{model_id}/delta", "purpose": "cross-scan comparison (weight-space tier preferred)", "params": ["with", "metric", "n", "min_change_pct", "fields"]},
    ]
    return {
        "api_version": "0.2",
        "docs": "/docs",
